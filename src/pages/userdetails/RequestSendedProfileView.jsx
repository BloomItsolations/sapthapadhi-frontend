...
import { clearError, denayRequest, sendRequest, singleUserDetails } from '../../store/userSlice';
    ...
    return (
        <div className="container" style={{ width: '100%' }}>
            ...
            <section className="userDetails card">
                ...
                <div className="btns">
                    <ul>
                        <li className="flex items-center space-x-2 sm:space-x-3 p-2 sm:p-3 bg-gray-600 hover:bg-gray-700 text-white rounded-md shadow-md transition-colors duration-300 mt-2 sm:mt-3">
                            <i className="ri-send-plane-fill text-lg sm:text-xl"></i>
                            <button
                                disabled
                                style={{ color: 'white', opacity: 0.6, cursor: 'not-allowed' }}
                                className="text-white font-medium sm:font-semibold text-sm sm:text-base"
                            >
                                Interest Sended
                            </button>
                        </li>
...
export default RequestSendedProfileView;
