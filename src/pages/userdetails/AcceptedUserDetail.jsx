                ...
                <div className="btns">
                    <ul>
                        <li className="sendMsg">
                            <Link to="/app/chat" className="flex items-center space-x-2 p-2 bg-blue-500 hover:bg-blue-600 text-white rounded-md">
                                <i className="ri-chat-4-fill text-lg"></i>
...
export default AcceptedUserDetail;
